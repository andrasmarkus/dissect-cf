...
public abstract class Device extends Timed {
    ...
    public long sentCapsule;
    public long arrivedActuatorEvents;
    ...
    /**
     * Getter for the application which processes the data generated by a device.
     */
    ...
    public static class DeviceNetwork {
        ...
        public HashMap < String, Integer > lmap;
        public int latency;
