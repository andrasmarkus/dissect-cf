...
public class IoTSimulation {
	...
	for(int i=0;i<500;i++) {
		...
		new Station(10*60*1000, 50,dn, new Actuator(new ActuatorRandomStrategy()), 0, 24*60*60*1000,50, "random", new SensorCharacteristics(5, 5,30000, 60000, 0.3), 60*1000, 0, 0).startMeter();
	}
